class MtechStudent < ActiveRecord::Base
 
     belongs_to :pg_branches
     #belongs_to :placement_search
     has_many :mtech_student_registrations
     has_many :pg_companies, :through => :mtech_student_registrations
    ...
    #  end
     ...
     validates_numericality_of :sgpa_sem3, :less_than_or_equal_to=>10.0,:greater_than_or_equal_to=>0, :allow_blank=>true, :message=>"is not valid"
     validates_numericality_of :sgpa_sem4, :less_than_or_equal_to=>10.0,:greater_than_or_equal_to=>0, :allow_blank=>true, :message=>"is not valid"

     validates_presence_of :sgpa_sem1, :message => "can't be blank"
     validates_presence_of :sgpa_sem2, :message => "can't be blank"

     validates_numericality_of :mtech_be_cgpa, :less_than_or_equal_to => 10.0, :greater_than_or_equal_to => 0.0,  :allow_blank => true, :message => "is not valid"
     validates_numericality_of :mtech_be_per,  :less_than_or_equal_to => 100.0, :greater_than_or_equal_to => 0.0, :allow_blank => true, :message => "is not valid"
     
     validates_numericality_of :mtech_cgpa,  :less_than_or_equal_to=>10.0, :greater_than_or_equal_to=>0, :message=>"is not valid"    
     validates_presence_of     :mtech_cgpa,  :message => "can't be blank"
