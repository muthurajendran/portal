class AdminController < ApplicationController
  ...
  def registrations
      ...
      @company = Company.where("academic_year1 = ? and academic_year2 = ?",params[:academic_year1], params[:academic_year2])
  ...
  #do nothing  
   ...
   def registrations_mca
       @year1=params[:academic_year1]
       @year2=params[:academic_year2]

       @pg_company=PgCompany.where("academic_year1 = ? and academic_year2 = ?",params[:academic_year1], params[:academic_year2])
 ...
 # Logic-- When a student is placed in a service based company his "count" attribute changes to 1 and if she/he's placed in core company it changes to 2
  ...
  def update_placed_and_remove_ineligible
     ...
     #@remove_service_or_core=StudentRegistration.where("student_id = ?",params[:id][0])
      ...
      #  @remove_service_or_core.each do |remove_service|
       ...
       # end
    # end
     redirect_to(:action => 'registrations',:academic_year1=>@year1,:academic_year2=>@year2)
     return  
     end
  end 
  ...
  def update_placed_and_remove_ineligible_for_mtech
     ...
     redirect_to(:action => 'registrations_mtech',:academic_year1=>@year1,:academic_year2=>@year2)
     return  
     end
  end
 ...
 def update_placed_and_remove_ineligible_for_mca
     ...
     redirect_to(:action => 'registrations_mca',:academic_year1=>@year1,:academic_year2=>@year2)
     return  
     end
  end 
