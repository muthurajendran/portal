class CreateMcaStudents < ActiveRecord::Migration
  def self.up
    create_table :mca_students do |t|
     ...
     add_index(:mca_students,:pg_branch_id)
       add_index(:mca_students,:reg_no)
       add_index(:mca_students,:sem)
  end

  def self.down
    drop_table :mca_students
  end
end
