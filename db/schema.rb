...
ActiveRecord::Schema.define(:version => 20120601055213) do
  ...
  create_table "companies", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "academic_year1",                                   :default => 2011
    t.integer  "academic_year2",                                   :default => 2012
  end
  ...
  create_table "mca_students", :force => true do |t|
    ...
    t.string   "question"
    t.string   "answer"
    t.boolean  "question_set",                                                    :default => false
  end
